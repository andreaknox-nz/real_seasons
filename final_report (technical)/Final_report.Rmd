...
* In the scatterplots, log(Rainfall) appears non-continuous at lower values. This is a combination of the effect of the log transformation on the lowest values, and the fact that rainfall measurements are rounded to the nearest 0.2mm (see the section above on Further investigation of the rainfall variable).
